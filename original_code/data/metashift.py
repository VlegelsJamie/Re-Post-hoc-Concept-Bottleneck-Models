...
def load_metashift_data(preprocess, task, **kwargs):
    np.random.seed(kwargs['seed'])

    df = pd.read_csv(os.path.join(METASHIFT_DATA_DIR, 'isic_metadata.csv'))
    all_image_paths = glob(os.path.join(METASHIFT_DATA_DIR, '*', '*.jpg'))
